...
const CountdownTimer: React.FC<{ targetDate: Date }> = ({ targetDate }) => {
  ...
  return (
    <div className="inline-block bg-white/95 backdrop-blur-sm py-3 px-3 sm:py-6 sm:px-8 rounded-2xl sm:rounded-full shadow-xl shadow-muted/5 border border-muted/20 max-w-full">
