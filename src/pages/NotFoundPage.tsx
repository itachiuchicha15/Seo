...
import { ROUTES, NOT_FOUND_STRINGS } from '../constants';
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] bg-light text-center px-4">
      <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-200">
        ...
        <h1 className="mt-8 text-6xl font-extrabold text-dark tracking-tighter">{NOT_FOUND_STRINGS.code}</h1>
        <h2 className="mt-2 text-3xl font-bold text-dark">{NOT_FOUND_STRINGS.title}</h2>
